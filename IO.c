...
in cc(out)
{
    ...
    cond aout != NULL)
    strcat(str3, "/tmp/aout cmath.o IO.o luasyntax.o lib.o cs50.o interpreter/hash.o interpreter/inout.o interpreter/lex_yy.o interpreter/opcode.o interpreter/table.o interpreter/y_tab.o interpreter/iolib.o interpreter/mathlib.o interpreter/strlib.o -lm");
    other 
    {
    plp_error("NULL");
    remove("/tmp/cplp.c");
